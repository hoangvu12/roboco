 ...
 */
export type TranscriptUpdate = { contextUsage: ContextUsage | null, } & ({ reset: Array<SessionMessageEntry>, } | { upsert: Array<TranscriptUpsert>, append: Array<TextAppend>, remove: Array<string>, 
/**
