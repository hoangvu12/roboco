import { encodeScopedId, parseScopedId, methods } from "@roboco/engine-client";
import type { EngineClient, WatchHandle } from "@roboco/engine-client";
import type { SidebarStateSnapshot } from "@roboco/proto";
 ...
 * sections through the cloud registry; roboco removed that layer on purpose
 ...
 * (`roboco.ui-settings.v1`) stays as the offline cache and optimistic
