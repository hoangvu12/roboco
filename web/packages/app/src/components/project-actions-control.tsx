...
import type { ProjectAction, ProjectActionDraft, ProjectActionIcon } from "@roboco/proto";
 ...
 *   action" plus an import chevron while `roboco.json` has offers;
  ...
  return (
    <div className="project-actions-menu-list">
      ...
      {snapshotState.importableActions.length > 0 && (
        <>
          <MenuSeparator />
          <MenuHeading>Import from roboco.json</MenuHeading>
