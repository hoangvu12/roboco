...
use roboco_doc::{SessionMessageEntry, TranscriptBaseline};

pub(crate) const REPLAY_ORIGIN: &str = "roboco:transcript-replay";
...
mod tests {
    use super::*;
    use std::sync::Mutex;
    use roboco_doc::{MessagePart, MessageRole, MessageStatus, SegmentWriter, SessionDoc};
