...
//!
//! Port of zeron's bounded session pump (a3c370b5 "recover from stalled
//! sockets with bounded session pumps" + efa1a075 "keep slow transfers
//! progressing", tests from 94cc6753). Reads and writes own independent await
