...
impl Pickers {
    ...
    /// Enter on the harness/model popover: pick the highlighted model, or
    /// open/confirm the highlighted nested model setting.
    ...
    /// [`Self::popover_frame`] without the shared inset — the harness/model
